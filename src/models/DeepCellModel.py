...
Wang XJ, Dilip R, Iqbal AR, Bussi Y, Brown C, Pradhan E, Jain Y, Yu K, Li S, Abt M,
Börner K, Keren L, Yue Y, Barnowski R, Van Valen D. 

https://pubmed.ncbi.nlm.nih.gov/39605651/
...
class CellTypeDataEncoder(nn.Module):
    ...
    def __init__(self, n_filters, n_heads, marker_embeddings, img_feature_extractor,
                embed_size=256  # jonte edit, temporary
                                # is this supposed to be at
                                # n_filters in nn.Linear?
                 ):
