...
from src.utils.eva_kit.layers import MarkerEmbeddingGenePT
from src.utils.eva_kit.layers import MaskedBlock as Block
from src.utils.eva_kit.layers import PatchEmbedChannelFree
from src.utils.eva_kit.masking import random_masking
from src.utils.eva_kit.pos_embed import get_2d_sincos_pos_embed
...
class MaskedAutoencoderViT(nn.Module):
    ...
    def __init__(self, conf):
        ...
        marker_dict = pickle.load(open(os.path.join(os.getcwd(),"src","utils","eva_kit","GenePT_embedding.pkl"), "rb"))
